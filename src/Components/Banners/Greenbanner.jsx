...
const Greenbanner = () => {
    return (
        <section className="min-h-[550px] flex items-center">
            <div className="container">
                <div className="bg-greenColor text-white rounded-3xl grid grid-cols-1 md:grid-cols-3 gap-5 py-8">
                    {/* First col */}
                    <div className="p-6 sm:p-8 flex flex-col justify-center items-start">
                        <p data-aos="slide-right">30% OFF</p>
                        <h1 data-aos="zoom-out" className="text-4xl lg:text-7xl font-bold">HAPPY HOURS</h1>
                        <p data-aos="fade-up">8 Feb to 1 Mar</p>
                    </div>
                    {/* Second col */}
                    <div className="flex justify-center" data-aos="zoom-in">
                        <img
                            src="/public/images/greenWatch.png"
                            alt="Headphone image"
                    ...
                    <div className="space-y-3 p-6 sm:p-8 flex flex-col justify-center items-start">
                        <p data-aos="zoom-out" className="font-bold text-xl lg:text-2xl">Smart Solo</p>
